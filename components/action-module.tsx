  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">Action Module</h2>
                      ...
                      {whatsappTemplates.map((template) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-2">
                            ...
                            {selectedWhatsAppTemplate === template.id && <Check className="h-5 w-5 text-green-500" />}
                          </div>
                      ...
                      {emailTemplates.map((template) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-2">
                            ...
                            {selectedEmailTemplate === template.id && <Check className="h-5 w-5 text-blue-500" />}
                          </div>
      ...
      <div className="flex justify-end space-x-4">
        ...
        <Button>Activate Cross-Sell Journey</Button>
      </div>
    </div>
  )
}
